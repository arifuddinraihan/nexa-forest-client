...
const WebFeatures = () => {
  return (
<section class="text-gray-600 body-font dark:text-slate-200">
  <div class="container px-5 py-24 mx-auto">
    <h1 class="sm:text-3xl text-2xl font-medium title-font text-center text-gray-900 mb-20 dark:text-slate-200">Raw Denim Heirloom Man Braid
