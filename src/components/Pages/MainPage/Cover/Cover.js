            ...
            <div className="relative w-full">
              ...
              <div className="absolute flex flex-col justify-start transform -translate-y-1/2 left-3 md:left-24 top-1/2">
                <h1 className="text-2xl md:text-4xl lg:text-5xl text-bold text-white">
                  ...
                  NexaForest
                  <br className="" />
                  We provide <br className="" /> best online Plant Delivery
                </h1>
                <p className="my-8 w-1/2 text-white text-sm md:text-lg">
                  Our service always completed on time. We have some best
                  customer experience, also we provide one of the best
                  experiences to you.
                </p>
                <div className="flex flex-row flex-start gap-4">
                  <Link
                    to={"/all-services"}
                    className="btn btn-xs md:btn-md btn-outline btn-primary rounded-xl"
                  >
                    Discover More
                  </Link>
                  <Link
