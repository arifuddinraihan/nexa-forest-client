                        ...
                        <div className="flex-1 xl:mx-8">
                            <div className="mt-8 space-y-8 md:-mx-4 md:flex md:items-center md:justify-center md:space-y-0 xl:mt-0">
                                <div className="max-w-sm mx-auto border rounded-lg md:mx-4 dark:border-gray-700">
                                    <div className="p-6">
                                        <h1 className="text-xl font-medium text-gray-700 capitalize lg:text-3xl dark:text-white">Essential</h1>

                                        <p className="mt-4 text-gray-500 dark:text-gray-300">
                                            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Nostrum quam voluptatibus
                                        </p>

                                        <h2 className="mt-4 text-2xl font-medium text-gray-700 sm:text-4xl dark:text-gray-300">$3.00 <span className="text-base font-medium">/Month</span></h2>
                                ...
                                <div className="max-w-sm mx-auto border rounded-lg md:mx-4 dark:border-gray-700">
                                    <div className="p-6">
                                        ...
                                        <h2 className="mt-4 text-2xl font-medium text-gray-700 sm:text-4xl dark:text-gray-300">$50.00 <span className="text-base font-medium">/life time</span></h2>
